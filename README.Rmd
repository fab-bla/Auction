...
boxplot(Award_Price ~ Model, xlab = "", ylab = "Award Price",
        ...
        outcol = c("cornflowerblue", "darkgoldenrod1", "firebrick", "forestgreen",
                "darkmagenta", "wheat3"), 
...
The boxplot shows that the Lasso regression seems to be able to predict the outliers the best when compared to the random forest and the Engineer's Estimate.
