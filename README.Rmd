...
# ggsave("./Thesis/figures/percomp_pres.pdf", plots, width = 12, height = 8)

# base plot for thesis
...
#   Act_vs_Pred(Act, Pred, 
#             title = title, bg_alt = bool, size = 2.5, shape = 21, alpha = 0.5,
#             outcol = "black", fill = fill, text = TRUE) 
#   
#   
# }, AWPs, c("Lasso Regression", "LM with logPCA Preprocessing", 
#            "RF with logPCA Preprocessing", "RF with Recursive Feature Elimination", 
...
# assign plots
# plots <- (plots[[1]] + plots[[6]]) /
#          (plots[[3]] + plots[[4]]) /
#          (plots[[5]] + plots[[2]])

# save
# ggsave("./Thesis/figures/percomp.pdf", plots, width = 10, height = 12)
```
