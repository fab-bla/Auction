...
\begin{figure}[H]
	\includegraphics[width = 12	cm]{figures/description_words_cloud.pdf}
...
The depiction of the top 20 bidders represents the unique identifiers of the firms that submitted the most bids. It is interesting to see that 
