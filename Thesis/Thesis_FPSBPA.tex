				...
				\item For all $K$ cross validation folds, repeat:
					...
					\begin{enumerate}[I.]
						...
						\begin{enumerate}[i.]
							...
							\item Calculate the error using the loss function $L$.
			...
			\begin{enumerate}
				...
				\begin{enumerate}
					...
					\begin{enumerate}[I.]
						...
						\item Predict the responses in the validation set.
