...
\begin{itemize}
\item
  Can machine learning methods be used to provide an improvement over
  the engineer's estimate in predicting the award price of auctions held
  by the CDOT?
...
\item
  ...
  \tightlist
  \item
    Does the interaction of certain firms lead to a systematic increase
    in the award price of auctions?
  \end{itemize}
\end{itemize}
\end{frame}
