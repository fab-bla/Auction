...
# Methods: Elastic Net
An elastic net is a linear model that utilizes $\ell_1$ and $\ell_2$ regularization, we may forumalte the elastic net as a constrained minimization problem, 
...
$$
Where $\alpha \in [0, 1]$ and $t \in \mathbb{R}^+$.
