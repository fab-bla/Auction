...
Since the Data does not contain any firm specific information and estimating cost functions is not feasible on firm level with the small data set at hand, we may sum up the cumulative sum over years of contracts won by all firms that participate in an auction. Given that firms have no other advantage than their constr structure this should account for potential difference in cost structure among participating companies.
