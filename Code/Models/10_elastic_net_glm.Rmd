...
# rmse
sqrt(sum((dat_train_aucs_eng[["Winning_Bid"]] - pred_vals_auc3)^2) / length(pred_vals_auc3))
```
...
# predict
pred_vals_test <- predict(fit_fin_test, dat_aucs_mod_eng[[2]])

# vals
par(mfrow = c(1, 2))
boxplot(dat_aucs_mod_eng[[2]][["Winning_Bid"]], ylim = c(0, 20e3), main = "Actual",
        pch = 19, outcol = "darkblue", col = "cornflowerblue")
boxplot(pred_vals_test , ylim = c(0, 20e3), main = "Predicted", pch = 19, outcol = "darkblue",
        col = "cornflowerblue")

# rmse
sqrt(sum((dat_aucs_mod_eng[[2]][["Winning_Bid"]] - pred_vals_test)^2) / length(pred_vals_test))
sqrt(sum((dat_aucs_mod_eng[[2]][["Winning_Bid"]] - dat_aucs_mod_eng[[2]][["Eng_Est"]])^2) / length(pred_vals_test))
```
