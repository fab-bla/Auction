...
```{r}
# train 
train <- dat_aucs[["Train"]]
train$Winning_Bid <- train$Winning_Bid / 1e3
...
#                                  type.measure = "mse", nfolds = 5,
#                                  alpha = c(0.99, 1),
#                                  lambda = seq(0.5, 10000, 50))

# save
# saveRDS(cvfit_auc_eng, "./../../Data/Models/Glmnets/Raw/cvfiteng.RDS")

# read file 
cvfit_auc_eng <- readRDS("./../../Data/Models/Glmnets/Raw/cvfiteng.RDS")
